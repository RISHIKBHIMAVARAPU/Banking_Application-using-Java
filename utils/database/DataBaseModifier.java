...
public class DataBaseModifier {
    ...
    public static void deleteAccount(String[] args) {
        ...
        try (PreparedStatement stmt = con.prepareStatement(query)) {
            ...
            stmt.setString(2, Class2.encryptString(args[2]));
    ...
    public static boolean withdraw(String[] args) {
        ...
        if (obj != null) {
            if (obj.getClass().equals(CurrentAccountUser.class)) {
                if (((CurrentAccountUser) obj).getPassword().equals(Class2.encryptString(args[3]))) {
                ...
                if (((SavingAccountUser) obj).getPassword().equals(Class2.encryptString(args[3]))) {
